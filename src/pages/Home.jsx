      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg transition-colors duration-200">
            ...
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Seguridad</h3>
            <p className="text-gray-800 dark:text-gray-300">
        ...
        <div className="mt-16 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 transition-colors duration-200">
